...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_json', type=str, default='/home/ljy/dataset/coco2014-unzip/caption_datasets/dataset_coco.json', help='input json file to process into hdf5')
    parser.add_argument('--image_root', type=str, default='/home/ljy/dataset/coco2014-origin-zip',
                    help='In case the image paths have to be preprended with a root path to an image folder')
    parser.add_argument('--input_box_dir', type=str, default='/home/ljy/dataset/relation_ts/cocobu_box',
                    help='path to the directory containing the boxes of att feats')
    parser.add_argument('--output_dir', type=str, default='/home/ljy/dataset/relation_ts/cocobu_adaptive_box_relative',
