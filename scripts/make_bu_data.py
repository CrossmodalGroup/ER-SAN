...
# output_dir
parser.add_argument('--downloaded_feats', default='/home/ljy/dataset', help='downloaded feature directory')
parser.add_argument('--output_dir', default='/home/ljy/dataset/relation_ts/cocobu', help='output feature files')
...
#s.makedirs(args.output_dir+'_att')
#s.makedirs(args.output_dir+'_fc')
#s.makedirs(args.output_dir+'_box')
